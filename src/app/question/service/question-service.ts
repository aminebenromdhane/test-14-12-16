...
export class QuestionService {
  ...
  getStaicData():Question {
    return new Question(
      'http://techslides.com/demos/sample-videos/small.mp4',
      [
        '<h4>Title of the question</h4>',
        '<p>this is the first sample paragraph htmlthis is the first sample paragraph htmlthis is the first sample paragraph htmlthis is the first sample paragraph htmlthis is the first sample paragraph htmlthis is the first sample paragraph html</p>',
        '<img src="http://www.flooringvillage.co.uk/ekmps/shops/flooringvillage/images/request-a-sample--547-p.jpg" width="400">'
      ],
      [new Comment({
        isVideo: false,
        rate: 6,
